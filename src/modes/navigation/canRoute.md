...
| 名稱 | CAN ID | DLC | 何時送 |
|---|---|---|---|
| ROUTE_HDR 路線表頭 | `0x2940020` | 5 | 進入導航時送一次 |
| ROUTE_SEG 路段資料 | `0x2940021` | 7 | 開始導航先上傳每一段；行進中每換一段再送目前段 |

## ROUTE_HDR (0x2940020) — 5 bytes
...
`CAN,2940021,7,03,20,03,F4,01,20,03`
